...
class TicketServiceImplTest {
    ...
    @Test
    void shouldMakePaymentAndReserveSeat_whenRequestIsValid() throws InvalidPurchaseException {
        long accountId = 1L;
    ...
    @Test
    void shouldMakePaymentAndReserveSeat_whenOnlyAnAdultTicketRequested() {
        long accountId = 1L;
    ...
    @Test
    void shouldMakePaymentAndReserveSeat_when10AdultsAnd10InfantTicketsRequested() {
        long accountId = 1L;
    ...
    @Test
    void shouldThrowInvalidPurchaseException_whenInvalidAccountIdIsGiven()
    ...
    @Test
    void shouldThrowInvalidPurchaseException_whenKidsTicketsWithoutAdultTicket()
            throws InvalidPurchaseException {
        Long accountId = 1L;
        TicketTypeRequest childTicket = new TicketTypeRequest(CHILD, 1);
        TicketTypeRequest infantTicket = new TicketTypeRequest(INFANT, 1);
        ...
        Assertions.assertEquals("Cannot purchase child or infant tickets without " +
                        "purchasing an adult ticket.",
                exception.getMessage());
    }

    @Test
    void shouldThrowInvalidPurchaseException_whenChildTicketRequestedWithoutAdultTicket()
            throws InvalidPurchaseException {
        Long accountId = 1L;
        TicketTypeRequest childTicket = new TicketTypeRequest(CHILD, 1);
    ...
    @Test
    void shouldThrowInvalidPurchaseException_whenInfantTicketRequestedWithoutAdultTicket()
            throws InvalidPurchaseException {
        Long accountId = 1L;
        TicketTypeRequest infantTicket = new TicketTypeRequest(INFANT, 1);
        ...
        Assertions.assertEquals("Cannot purchase infant tickets without an " +
                        "associated adult ticket.",
                exception.getMessage());
    }
    ...
    void shouldThrowInvalidPurchaseException_whenMoreInfantTicketsRequestedThanAdult()
        ...
        Long accountId = 1L;
        TicketTypeRequest adultTicket = new TicketTypeRequest(ADULT, 2);
        TicketTypeRequest infantTicket = new TicketTypeRequest(INFANT, 3);

        InvalidPurchaseException exception = assertThrows(InvalidPurchaseException.class,
                () -> ticketServiceImpl.purchaseTickets(accountId, adultTicket, infantTicket));

        Assertions.assertEquals("Cannot have more infants tickets than adult tickets.",
                exception.getMessage());
    }
    ...
    void shouldThrowInvalidPurchaseException_whenOneTicketTypeRequestIsNull()
        ...
        Assertions.assertEquals("Ticket type request is not valid.",
                exception.getMessage());
    }
